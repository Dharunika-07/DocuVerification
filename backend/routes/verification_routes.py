...
# # # # #     risk_score, risk_level, fraud_indicators = FraudDetectionService.calculate_risk_score(
# # # # #         document['extracted_text'],
# # # # #         gemini_response
# # # # #     )
...
# # # # #     verification = VerificationModel.find_by_id(mongo.db, verification_id)
# # # # #     if not verification:
...
# # # # #After testing with the fake passport
# # # # from flask import Blueprint, request
# # # # from flask_jwt_extended import jwt_required, get_jwt_identity
# # # # from models.document_model import DocumentModel
# # # # from models.verification_model import VerificationModel
...
# # # #After testing from the website sent to whatsapp
# # # from flask import Blueprint, request
# # # from flask_jwt_extended import jwt_required, get_jwt_identity
# # # from models.document_model import DocumentModel
# # # from models.verification_model import VerificationModel
...
# # #     if forensic_score > 60 or not date_validation['is_valid']:
# # #         auto_decision = 'rejected'
...
# #extra functionalit after failed to detect fake passport
...
#after cahnging gemini_service for detection of wrong ai analysis
